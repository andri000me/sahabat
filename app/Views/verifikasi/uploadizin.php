...
<div class="container-fluid" style="margin-bottom:300px;">
    <form method="POST" class="needs-validation md-form text-left" style="color: #757575;" action="/verifikasi/saveuploadizin" enctype="multipart/form-data" novalidate>
        ...
        <input name="img_izin_akdp_lama" type="hidden" value="<?= $detail['img_izin_akdp'] ?>">

        <div class="my-4 px-3 py-3" style="width:1000px;">
            <h5 class="text-primary font-weight-bold card-title">Upload Izin Trayek AKDP</h5>
                ...
                <div class="md-form">
                    <div class="file-field">
                        ...
                        <div class="btn btn-dark btn-sm float-left">
                            ...
                            <input type="file" name="img_izin_akdp" id="uploadImage">
                        </div>

                        <?php
                        if ($detail['img_izin_akdp']) {
                            $btn = "btn-success";
                        } else {
                            $btn = "btn-danger";
                        }
                        ?>
                        <a href="/img/img_izin_akdp/<?= $detail['img_izin_akdp'] ?>" target="_blank" type="button" class="btn btn-sm <?= $btn ?>"><i class="fa fa-eye mr-1"></i> Lihat dokumen</a>
                        <div class="file-path-wrapper">
                            <input name="img_izin_akdp" class="file-path validate" type="text" placeholder="Izin Trayek">
                        </div>
                        <div class="kacili" style="margin-left:280px;">
                            <?= $validation->getError('img_izin_akdp') ?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="buttons mt-3">
                <button type="submit button" class="btn btn-md btn-primary text-light">Upload<i class="fa fa-check ml-1"></i> </button>
            </div>
        </div>
    </form>
</div>
