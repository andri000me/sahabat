            ...
            <div class="px-4 pt-3">
                <div class="card-body">
                    <div class="container">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-10">
                                <p class="text-justify text-pppadat">Sesuai persyaratan administrasi teknis dan khusus, <a class="font-weight-bold">Tidak Dapat <?= $d ?> Izin Trayek Angkutan</a> Antar Kota Dalam Provinsi (AKDP) dengan ketentuan sebagai berikut : </p>
                            </div>
                        </div>
