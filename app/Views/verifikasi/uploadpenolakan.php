...
<div class="container-fluid" style="margin-bottom:300px;">
    <form method="POST" class="needs-validation md-form text-left" style="color: #757575;" action="/verifikasi/savepenolakan" enctype="multipart/form-data" novalidate>
        ...
        <div class="my-4 px-3 py-3" style="width:1000px;">
            <h5 class="text-danger font-weight-bold card-title">Upload Surat Penolakan Rekomendasi Izin Trayek AKDP</h5>
            ...
            <div class="buttons mt-3">
                <button type="submit button" class="btn btn-md btn-danger text-light">Upload Penolakan AKDP<i class="fa fa-check ml-1"></i> </button>
            </div>
        </div>
    </form>
</div>
