                                    ...
                                    <tr>
                                        ...
                                        if ($tr['status_verifikasi'] == 4) {
                                            if ($tr['img_penolakan']) {
                                                ...
                                                $btn2 = '<a target="_blank" href="/img/img_penolakan/' . $tr['img_penolakan'] . '" target="_blank" type="btn" class="ml-auto btn btn-sm btn-rounded btn-danger animated rotateIn"><i class="fa fa-upload"></i> Unduh surat penolakan</a>
