                ...
                <div class="col-lg-3 col-md-4">
                    <div class="info">
                        <div>
                            ...
                            <p>Kompleks Perkantoran Pemprov. Gorontalo Lt. 2 <br>Jln. Thayeb Moh. Gobel Kec. Bolango Selatan Kab. Bone Bolango</p>
                        </div>

                        <div>
                            <i class="ion-ios-email-outline"></i>
                            <p>dishubprovgorontalo@gmail.com</p>
                        </div>
    ...
    <!-- <section id="login">
        ...
        <div class="container">
            <div class="section-header">
                ...
                <span class="section-divider"></span>
                <p class="section-description">Silahkan masukkan username dan password anda untuk Login</p>
            </div>
            <div class="row wow fadeInUp logins">
                <div class="col-lg-5 col-md-8">
                    <div class="form">
                        <form action="forms/contact.php" method="post" role="form" class="php-email-form">
                            <div class="form-group">
                                <input type="email" class="form-control" name="subject" id="subject" placeholder="Email/Username" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject">
                                <div class="validate"></div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="text-center"><a href="/rekomendasi" title="Send Message">Login</a></div>
                        </form>
                    </div>
                </div>
            </div>
