...
<div class="container-fluid mt-t" style="margin-bottom:500px;">
    <div class="px-5 py-5">
        ...
        <div class="row animated zoomIn">
            <div class="col">
                <h4 class="text-dark font-weight-bold card-title">Cek Kartu Pengawasan</h4>
                <p class="card-text">Masukkan Plat kendraan anda untuk mengetahui masa berlaku Kartu Pengawasan</p>
            </div>
        </div>
