...
<div class="container-fluid" style="margin-bottom:300px;">
    <form method="POST" class="needs-validation md-form text-left" style="color: #757575;" action="/ask/saveUploadberitaacarapenerbitan" enctype="multipart/form-data" novalidate>
        ...
        <div class="my-4 px-3 py-3" style="width:1000px;">
            <h5 class="text-success font-weight-bold card-title">Upload Berita Acara Penerbitan Izin Penelenggaraan AOTDT</h5>
                ...
                <div class="md-form">
                    <div class="file-field">
                        <div class="btn btn-primary btn-sm float-left">
                            ...
                            <input type="file" name="img_penerbitan" id="uploadImage">
                        </div>

                        <?php
                        if ($ask['img_penerbitan']) {
                            $link = 'href="/img/img_penerbitan/' . $ask['img_penerbitan'] . '"';
                            $btn = "btn-success";
                        } else {
                            $link = "#";
                            $btn = "btn-danger";
                        ...
                        <div class="file-path-wrapper">
                            <input name="img_penerbitan" class="file-path validate" type="text" placeholder="Berita Acara Penerbitan Izin AOTDT">
                        </div>
                    </div>
                    <div class="kacili" style="margin-left:280px;">
                        <?= $validation->getError('img_penerbitan') ?>
                    </div>
                </div>
            </div>

            <div class="buttons mt-3">
                <button type="submit button" class="btn btn-md btn-success text-light">Upload<i class="fa fa-upload ml-1"></i> </button>
            </div>
        </div>
    </form>
</div>
