...
<div class="container-fluid" style="margin-bottom:300px;">
    <form method="POST" class="needs-validation md-form text-left" style="color: #757575;" action="/ask/saveberitaacara" enctype="multipart/form-data" novalidate>
        ...
        <div class="my-4 px-3 py-3" style="width:1000px;">
            <h5 class="text-success font-weight-bold card-title">Upload Berita Acara</h5>
                ...
                <div class="md-form">
                    <div class="file-field">
                        ...
                        <div class="file-path-wrapper">
                            <input name="img_permohonan" class="file-path validate" type="text" placeholder="Beria Acara Persetujuan Izin ASK">
                        </div>
                    </div>
