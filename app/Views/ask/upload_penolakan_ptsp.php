...
<div class="container-fluid" style="margin-bottom:300px;">
    <form method="POST" class="needs-validation md-form text-left" style="color: #757575;" action="/ask/savePenolakanPTSP" enctype="multipart/form-data" novalidate>
        ...
        <div class="my-4 px-3 py-3" style="width:1000px;">
            <h5 class="text-danger font-weight-bold card-title">Upload Surat Penolakan Permohonan</h5>
                ...
                <div class="md-form">
                    <div class="file-field">
                        ...
                        if ($ask['img_penolakan_ptsp']) {
                            $link = 'href="/img/img_penolakan_ptsp/' . $ask['img_penolakan_ptsp'] . '"';
                            $btn = "btn-success";
                        } else {
                            $link = "#";
                            $btn = "btn-danger";
                        ...
                        <div class="file-path-wrapper">
                            <input name="img_penolakan_ptsp" class="file-path validate" type="text" placeholder="Surat Penolakan PTSP">
                        </div>
                    </div>
                    <div class="kacili" style="margin-left:280px;">
                        <?= $validation->getError('img_penolakan_ptsp') ?>
                    </div>
                </div>
            </div>
