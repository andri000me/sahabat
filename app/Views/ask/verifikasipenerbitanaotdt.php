                                    ...
                                    <?php foreach ($ask as $ran) : ?>
                                        <tr>
                                            ...
                                            if ($ran['penerbitan'] == 1 && $ran['status_penerbitan'] == 2) {
                                                $status2 = "";
                                                $status = '<a href="" class="badge badge-warning">Perlu diverifikasi</a>';
                                                $button = '<a href="/ask/detailverifikasipenerbitan/' . $ran['slug'] . '/' . $ran['kode_registrasi'] . '" class="btn btn-sm btn-warning">Verifikasi</a>
                                                ';
                                            }
                                            if ($ran['penerbitan'] == 1 && $ran['status_penerbitan'] == 3) {
                                                $status = '<a href="" class="badge badge-success">Diterima</a>';
                                                $button = '<a href="/ask/uploadizin/' . $ran['slug'] . '/' . $ran['kode_registrasi'] . '" class="btn btn-sm btn-success">Upload Izin AOTDT</a>';
                                                $status2 = "";
                                                if ($ran['img_izin']) {
                                            ...
                                            if ($ran['penerbitan'] == 1 && $ran['status_penerbitan'] == 4) {
                                                ...
                                                $button = '<a href="/ask/uploadpenolakanizin/' . $ran['slug'] . '/' . $ran['kode_registrasi'] . '" class="btn btn-sm btn-danger">Upload Penolakan Izin AOTDT</a>';
                                                $status2 = "";
