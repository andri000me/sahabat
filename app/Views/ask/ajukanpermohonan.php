        ...
        <div class="col-sm-12 mb-3 mb-md-0">
            <div class="">
                <div class="card-body">
                    ...
                    <h5 class="text-dark font-weight-bold card-title">Surat Permohonan Peenerbitan Izin Angkutan Orang Tidak Dalam Trayek</h5>
                            ...
                            <div class="md-form">
                                <div class="file-field">
                                    <div class="btn primary-color-dark text-light btn-sm float-left">
                                        ...
                                        <input type="file" name="img_penolakan_permohonan" id="uploadImage">
                                    </div>
                                    <?php
                                    if ($ask['img_penolakan_permohonan']) {
                                        $href = 'href="/img/img_penolakan_permohonan/' . $ask['img_penolakan_permohonan'] . '" target="_blank"';
                                        $btn = "success";
                                    } else {
                                        $btn = "danger";
                                        $href = 'href="#"';
                                    ...
                                    <div class="file-path-wrapper">
                                        <input name="img_penolakan_permohonan" class="file-path validate" type="text" placeholder="Scan / Foto Surat Permohonan Peenerbitan Izin Angkutan Orang Tidak Dalam Trayek">
                                    </div>
                                </div>
