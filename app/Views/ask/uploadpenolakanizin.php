...
<div class="container-fluid" style="margin-bottom:300px;">
    <form method="POST" class="needs-validation md-form text-left" style="color: #757575;" action="/ask/saveUploadpenolakanIzin" enctype="multipart/form-data" novalidate>
        ...
        <div class="my-4 px-3 py-3" style="width:1000px;">
            <h5 class="text-danger font-weight-bold card-title">Upload Penolakan Izin Penelenggaraan AOTDT</h5>
                ...
                <div class="md-form">
                    <div class="file-field">
                        <div class="btn btn-primary btn-sm float-left">
                            ...
                            <input type="file" name="img_penolakan_izin" id="uploadImage">
                        </div>

                        <?php
                        if ($ask['img_penolakan_izin']) {
                            $link = 'href="/img/img_penolakan_izin/' . $ask['img_penolakan_izin'] . '"';
                            $btn = "btn-success";
                        } else {
                            $link = "#";
                            $btn = "btn-danger";
                        ...
                        <div class="file-path-wrapper">
                            <input name="img_penolakan_izin" class="file-path validate" type="text" placeholder="Izin AOTDT">
                        </div>
                    </div>
                    <div class="kacili" style="margin-left:280px;">
                        <?= $validation->getError('img_penolakan_izin') ?>
                    </div>
                </div>
            </div>

            <div class="buttons mt-3">
                <button type="submit button" class="btn btn-md btn-danger text-light">Upload Surat Penolakan<i class="fa fa-upload ml-1"></i> </button>
            </div>
        </div>
    </form>
</div>
