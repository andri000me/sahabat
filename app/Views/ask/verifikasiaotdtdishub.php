                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($ask as $ran) : ?>
                                        ...
                                        if ($ran['rekompersetujuan'] == 1 && $ran['status_rekompersetujuan'] == 1) {
                                            ...
                                            <a onclick="return confirm(\'Yakin terima permohonan?\')" href="/ask/vterimapersetujuanizin/' . $ran['idask'] . '/' . $ran['slug'] . '/' . $ran['kode_registrasi'] . '" class="btn btn-sm btn-success">Terima</a>
                                            <a onclick="return confirm(\'Yakin tolak permohonan?\')" href="/ask/vtolakpersetujuanizin/' . $ran['idask'] . '/' . $ran['slug'] . '/' . $ran['kode_registrasi'] . '" class="btn btn-sm btn-danger">Tolak</a>';
                                            $btn3 = '';
                                        }
