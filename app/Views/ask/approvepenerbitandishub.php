                                    ...
                                    <?php foreach ($ask as $ran) : ?>
                                        <tr>
                                            ...
                                            if ($ran['rekompersetujuan'] == 1 && $ran['status_rekompersetujuan'] == 3 && $ran['status_penerbitan'] == 3) {
                                                ...
                                                <a onclick="return confirm(\'Apakah anda yakin?\')" href="/ask/saveapprovepenerbitandishub/' . $ran['idask'] . '/' . $ran['slug'] . '/' . $ran['kode_registrasi'] . '" class="btn btn-sm btn-success"> Approve <i class="fa fa-check"></i></a>
                                                <a onclick="return confirm(\'Apakah anda yakin melakukan penolakan?\')" href="/ask/disapprovepenerbitandishub/' . $ran['idask'] . '/' . $ran['slug'] . '/' . $ran['kode_registrasi'] . '" class="btn btn-sm btn-danger"> Tolak <i class="fa fa-ban"></i></a>';
                                                $btn3 = '';
                                            }
