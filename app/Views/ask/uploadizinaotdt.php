...
<div class="container-fluid" style="margin-bottom:300px;">
    <form method="POST" class="needs-validation md-form text-left" style="color: #757575;" action="/ask/saveUploadIzin" enctype="multipart/form-data" novalidate>
        ...
        <div class="my-4 px-3 py-3" style="width:1000px;">
            <h5 class="text-success font-weight-bold card-title">Upload Izin Penelenggaraan AOTDT</h5>
                ...
                <div class="md-form">
                    <div class="file-field">
                        <div class="btn btn-primary btn-sm float-left">
                            ...
                            <input type="file" name="img_izin" id="uploadImage">
                        </div>

                        <?php
                        if ($ask['img_izin']) {
                            $link = 'href="/img/img_izin/' . $ask['img_izin'] . '"';
                            $btn = "btn-success";
                        } else {
                            $link = "#";
                            $btn = "btn-danger";
                        ...
                        <div class="file-path-wrapper">
                            <input name="img_izin" class="file-path validate" type="text" placeholder="Izin AOTDT">
                        </div>
                    </div>
                    <div class="kacili" style="margin-left:280px;">
                        <?= $validation->getError('img_izin') ?>
                    </div>
                </div>
            </div>

            <div class="buttons mt-3">
                <button type="submit button" class="btn btn-md btn-success text-light">Upload Izin AOTDT<i class="fa fa-upload ml-1"></i> </button>
            </div>
        </div>
    </form>
</div>
