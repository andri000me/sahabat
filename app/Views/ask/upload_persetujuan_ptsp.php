...
<div class="container-fluid" style="margin-bottom:300px;">
    <form method="POST" class="needs-validation md-form text-left" style="color: #757575;" action="/ask/savepersetujuanPTSP" enctype="multipart/form-data" novalidate>
        ...
        <div class="my-4 px-3 py-3" style="width:1000px;">
            <h5 class="text-success font-weight-bold card-title">Upload Surat Persetujuan Permohonan</h5>
                ...
                <div class="md-form">
                    <div class="file-field">
                        <div class="btn btn-primary btn-sm float-left">
                            ...
                            <input type="file" name="img_persetujuan_ptsp" id="uploadImage">
                        </div>

                        <?php
                        if ($ask['img_persetujuan_ptsp']) {
                            $link = 'href="/img/img_persetujuan_ptsp/' . $ask['img_persetujuan_ptsp'] . '"';
                            $btn = "btn-success";
                        } else {
                            $link = "#";
                            $btn = "btn-danger";
                        ...
                        <div class="file-path-wrapper">
                            <input name="img_persetujuan_ptsp" class="file-path validate" type="text" placeholder="Surat Persetujuan PTSP">
                        </div>
                    </div>
            ...
            <div class="buttons mt-3">
                <button type="submit button" class="btn btn-md btn-success text-light">Upload Surat Persetujuan<i class="fa fa-upload ml-1"></i> </button>
            </div>
        </div>
    </form>
</div>
