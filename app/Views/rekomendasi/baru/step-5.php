    ...
    <div class="row mb-5 wow fadeInRight">
        <div class="col-sm-12 mb-3 mb-md-0">
            <div class="cards px-4 pt-3">
                <div class="card-body">
                    <h4 class="text-dark font-weight-bold card-title">Step 5 - Iuran Jasa Raharja </h4>
                    ...
                    <form method="POST" class="needs-validation md-form text-left" style="color: #757575;" action="/rekomendasi/update5/<?= $step5['id'] ?>" enctype="multipart/form-data" novalidate>
                        ...
                        if ($step5['img_jasa_raharja']) {
                            $img = $step5['img_jasa_raharja'];
                        } else {
                            $img = "default.png";
                        }
                        ?>
                        <div class="md-form">
                            <img id="uploadPreview" src="<?= base_url(); ?>/img/img_jasa_raharja/<?= $img ?>" style="width:250px;" alt="IMG">
