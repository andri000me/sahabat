        ...
        <div class="col-md-12">
            ...
            <ul class="stepper stepper-horizontal">
                ...
                <li class="<?= $complete ?> wow fadeInLeft">
                    ...
                    ?>
                    <a href="/rekomendasi/<?= $status ?>/<?= $step3['kode_booking'] ?>">
                ...
                <?php
                if ($step3['img_kir'] && $step3['nomor_kir'] && $step3['kapasitas_angkutan'] && $step3['uji_berkala_berlaku']) {
                    $complete = "completed";
                } else {
                    $complete = "";
                }
                ...
                <?php
                if ($step3['img_jasa_raharja'] && $step3['jasa_raharja_berlaku']) {
                    $complete = "completed";
                } else {
                    $complete = "";
                }
    ...
    <div class="row mb-5 wow fadeInRight">
        <div class="col-sm-12 mb-3 mb-md-0">
            <div class="cards px-4 pt-3">
                <div class="card-body">
                    <h4 class="text-dark font-weight-bold card-title">Syarat 3 - STNKB</h4>
                    <p class="card-text">Isi data sesuai dengan dokumen yang di upload</p>

                    <!-- Form -->
                    <form method="POST" class="needs-validation md-form text-left" style="color: #757575;" action="/rekomendasi/update3/<?= $step3['idpermohonan'] ?>" enctype="multipart/form-data" novalidate>
