...
<div class="modal fade" id="ModalDanger" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="t`rue">
    <div class="modal-dialog modal-notify modal-danger" role="document">
        ...
        <div class="modal-content">
            ...
            <!--Body-->
            <form method="POST" class="needs-validation md-form text-left" style="color: #757575;" action="/koperasi/tolak" enctype="multipart/form-data" novalidate>

                <input name="id" type="hidden" value="<?= $permohonan['idpermohonan'] ?>">
                <input name="mana" type="hidden" value="<?= $mana ?>">
                ...
                <div class="modal-body">
                    <div class="md-form mb-4 pink-textarea active-textarea">
                        ...
                        <label for="form18">Keterangan Pesan Penolakan</label>
                        <div class="invalid-feedback">
