...
if (!function_exists('datew_lengkap')) {
    function datew_lengkap($tanggal)
    {
        $ubahTanggal = gmdate($tanggal, time() + 60 * 60 * 8);
        $pecahTanggal = explode('-', $ubahTanggal);
        $tanggal = $pecahTanggal[2];
...
if (!function_exists('datew_medium')) {
    function datew_medium($tanggal)
    {
        $ubahTanggal = gmdate($tanggal, time() + 60 * 60 * 8);
        $pecahTanggal = explode('-', $ubahTanggal);
        $tanggal = $pecahTanggal[2];
...
if (!function_exists('datew_pendek')) {
    function datew_pendek($tanggal)
    {
        $ubahTanggal = gmdate($tanggal, time() + 60 * 60 * 8);
        $pecahTanggal = explode('-', $ubahTanggal);
        $tanggal = $pecahTanggal[2];
